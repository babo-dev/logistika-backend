...
Route::post('requests/', [CustomRequestController::class, 'index'])->name('requests.index');
...
Route::post('requests/create', [CustomRequestController::class, 'store'])->name('requests.store');
